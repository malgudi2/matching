{
  ...
  "Dṛḍhena": "Firm and steady; knowledge must be unwavering and well-assimilated.",
  "Chittvā": "Having cut asunder; destroying ignorance and attachment at their root.",
  ...
  "Mamaivāṁśaḥ": "My own fragment; the jīva is Consciousness reflected in matter, not a literal division of Brahman.",
  "Jīva-bhūtaḥ": "The individual soul; Pure Consciousness conditioned by the mind and senses.",
  "Manaḥ-ṣaṣṭhānīndriyāṇi": "The mind and six senses; instruments through which the jīva experiences the world.",
  "Prakṛti-sthāni": "Situated in matter; the jīva functions through material equipment.",
  "Karṣati": "Struggles; the jīva’s suffering due to identification with body-mind limitations.",
  "Vaishvānara": "The digestive fire; the same Consciousness functioning as the power of digestion in all beings.",
  "Prāṇa": "The vital energy governing intake and forward movement; an expression of the cosmic life-force.",
  "Apāna": "The vital energy governing elimination and downward movement; complementary to prāṇa.",
  "Smṛti": "Memory; the power of recollection bestowed by the Lord.",
  "Jñānam": "Knowledge; the capacity to know, understand, and discriminate.",
  "Apohanam": "Forgetfulness; also governed by the Lord, essential for functional living.",
  "Vedaiś ca Sarvaiḥ Aham Eva Vedyaḥ": "The ultimate purpose of all Vedas is the realization of the Self alone.",
  "Vedānta-kṛt": "The revealer and authoritativeness behind Vedānta; the Truth that expresses itself through the scriptures.",
  "Veda-vit Eva Cāham": "The true knower of the Vedas; Consciousness itself is the source and culmination of all knowledge."
}
